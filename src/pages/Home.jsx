    ...
    <div className="min-h-screen text-gray-800 bg-white">
      ...
      <section className="py-16 text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-extrabold mb-6">Welcome to CF Stalker</h2>
          <p className="text-xl mb-8">Stalk Codeforces profiles, detect plagiarisms, and uncover insightful trends effortlessly.</p>
      ...
      <section id="features" className="py-12 pt-0">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-10">
            ...
            {/* Feature 4 - Compare Profiles */}
            <div id="compare-profiles" className="shadow-lg rounded-lg p-8 text-center border border-gray-300">
              <h3 className="text-2xl font-bold mb-4">Compare Profiles</h3>
              <p>Compare two Codeforces users side-by-side with visual insights into their stats, problems, and tags.</p>
              <Link to="/compare" className="mt-6 inline-block px-5 py-3 rounded bg-blue-500 text-white hover:bg-blue-600 transition">Learn More</Link>
            </div>
          </div>
        </div>
      </section>
